...
# Reads in vcf file output produced by LoFreq call and prints human-readable
# heterozygosity table. Optionally filters output by read depth, minor allele readcount,
