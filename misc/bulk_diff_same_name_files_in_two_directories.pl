...
# my @filepaths_in_directory_1 = (); # list of all filepaths appearing in directory 1
...
# my @filepaths_in_directory_2 = (); # list of all filepaths appearing in directory 1
...
# sorts filepaths from the two directories
@filepaths_in_directory_1 = sort @filepaths_in_directory_1;
@filepaths_in_directory_2 = sort @filepaths_in_directory_2;
...
foreach my $file_name(sort keys %filename_appears_in_directory_1)
{
	if($filename_appears_in_directory_2{$file_name}) # file name appears in both directories
	{
		...
		my $filepath_1 = $directory_1.$file;
		my $filepath_2 = $directory_2.$file;
